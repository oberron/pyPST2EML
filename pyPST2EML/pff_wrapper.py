...
```bash
pffexport /mnt/e/2021Q2_mmWave.pst -f all -t 2021Q2_mmWave_test1
```
...
outlook_export_dir = "E:\\gitw\\pyPST2EML\\2021Q2_mmWave_test1.export\\Top of Outlook data file\\"
...
class Gen_Emails(object):
    ...
    def parse_txt_files(self):
        for file in ["OutlookHeaders.txt" ]:
